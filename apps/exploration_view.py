...
from apps.exploration import Exploration3D_Options, Network_Options, TextViz_Options
...
def tab_subpages(tab, user_id):
    ...
    # each view should handle on its own how changing the dataset it handled
    if tab == 'exploration':
