...
html.Br(), html.H3("""high_level_tabs(data_clicks, explore_clicks, analyze_clicks): """, style={"backgroundColor": "#AAA", "display": "inline"}), 
html.Div([
...
html.Br(), html.H3("""toggle_colors(n_clicks): """, style={"backgroundColor": "#AAA", "display": "inline"}), 
html.Div([
	html.P("""Embeds a javascript function in a dash component to allow changing the theme."""),
	html.P(""""""),
	html.H3("""Args:"""),
	html.P("""n_clicks (int): Number of times the theme button was clicked."""),
	html.P(""""""),
	html.H3("""Returns:"""),
	html.P("""str: Ties the JS script to the button."""),
], style={"marginLeft": "20px", "backgroundColor": "#CCE"}),

html.Br(), html.H3("""toggle_colors(n_clicks): """, style={"backgroundColor": "#AAA", "display": "inline"}), 
html.Div([
	html.P("""function change_theme () {"""),
	html.P("""// the css we are going to inject"""),
	html.P("""var css = 'html {-webkit-filter: invert(100%);' +"""),
	html.P("""'-moz-filter: invert(100%);' +"""),
	html.P("""'-o-filter: invert(100%);' +"""),
	html.P("""'-ms-filter: invert(100%); }',"""),
	html.P(""""""),
	html.P("""head = document.getElementsByTagName('head')[0],"""),
	html.P("""style = document.createElement('style');"""),
	html.P(""""""),
	html.P("""// a hack, so you can "invert back" clicking the bookmarklet again"""),
	html.P("""if (!window.counter) { window.counter = 1;} else  { window.counter ++;"""),
	html.P("""if (window.counter % 2 == 0) { var css ='html {-webkit-filter: invert(0%); -moz-filter:    invert(0%); -o-filter: invert(0%); -ms-filter: invert(0%); }'}"""),
	html.P("""};"""),
	html.P(""""""),
	html.P("""style.type = 'text/css';"""),
	html.P("""if (style.styleSheet){"""),
	html.P("""style.styleSheet.cssText = css;"""),
	html.P("""} else {"""),
	html.P("""style.appendChild(document.createTextNode(css));"""),
	html.P("""}"""),
	html.P(""""""),
	html.P("""//injecting the css to the head"""),
	html.P("""head.appendChild(style);"""),
	html.P("""}"""),
	html.P(""""""),
	html.P("""let theme_button = document.getElementById("dark_theme");"""),
	html.P("""theme_button.onclick = change_theme;"""),
	html.P(""""""),
], style={"marginLeft": "20px", "backgroundColor": "#CCE"}),
...
html.Br(), html.H3("""create_table(df, table_id="table", columns=None): """, style={"backgroundColor": "#AAA", "display": "inline"}), 
html.Div([
	...
	html.P("""columns (list(dict)): the column data passed to the data table."""),
	html.P(""""""),
	html.H3("""Returns:"""),
...
layouts["../EDA_miner/dash_rnd/_imports_"] = html.Div([
])



layouts["../EDA_miner/dash_rnd/ResizeDraggable"] = html.Div([
html.Br(), html.H3("""ResizeDraggable(Component): """, style={"backgroundColor": "#AAA", "display": "inline"}), 
html.Div([
	html.P("""ExampleComponent is an example component."""),
	html.P("""It takes a property, `label`, and"""),
	html.P("""displays it."""),
	html.P("""It renders an input with the property `value`"""),
	html.P("""which is editable by the user."""),
	html.P(""""""),
	html.H3("""Keyword arguments:"""),
	html.Li(""" children (dash component; optional)"""),
	html.Li(""" id (string; optional): The ID used to identify this component in Dash callbacks"""),
	html.Li(""" label (string; required): A label that will be printed when this component is rendered."""),
	html.Li(""" value (string; optional): The value displayed in the input"""),
	html.Li(""" minWidth (number; optional)"""),
	html.Li(""" minHeight (number; optional)"""),
	html.Li(""" x (number; optional)"""),
	html.Li(""" y (number; optional)"""),
], style={"marginLeft": "20px", "backgroundColor": "#CCE"}),
...
layouts["../EDA_miner/dash_rnd/__init__"] = html.Div([
])
...
layouts["../EDA_miner/apps/exploration/Maps"] = html.Div([
html.H2("""Maps.py"""), 
html.Br(), html.Div([
	html.P("""TBW..."""),
	html.P(""""""),
	html.H3("""TODO:"""),
	html.P("""Implement https://plot.ly/python/choropleth-maps/#choropleth-inset-map"""),
], style={"marginLeft": "20px", "backgroundColor": "#CCE"}),

html.Br(), html.H3("""Map_Options(options): """, style={"backgroundColor": "#AAA", "display": "inline"}), 
html.Div([
	html.P("""Generate the layout of the dashboard."""),
	html.P(""""""),
	html.H3("""Args:"""),
...
html.Br(), html.H3("""render_variable_choices_maps(dataset_choice, user_id): """, style={"backgroundColor": "#AAA", "display": "inline"}), 
html.Div([
...
html.Br(), html.H3("""country2code(value): """, style={"backgroundColor": "#AAA", "display": "inline"}), 
html.Div([
	html.P("""Country(alpha_2='DE', alpha_3='DEU', name='Germany', numeric='276',"""),
	html.P("""official_name='Federal Republic of Germany')"""),
], style={"marginLeft": "20px", "backgroundColor": "#CCE"}),

html.Br(), html.H3("""plot_map(lat_var, lon_var, country, z_var, map_type, aggregator_type, """, style={"backgroundColor": "#AAA", "display": "inline"}), 
html.Div([
	html.P("""Plot the map according to user choices."""),
	html.P(""""""),
	html.H3("""Args:"""),
	html.P("""lat_var (str): Column name for latitude."""),
	html.P("""lon_var (str): Column name for latitude."""),
	html.P("""country (str): Column name for the country. Accepted values include 3-letter country codes and full names                        or anything else pycountry can decode."""),
	html.P("""z_var (str): Column name for choropleth colors."""),
	html.P("""map_type (str): Type of math, one of three choices: Simple or                         Aggregated Choropleth, or Lines on map."""),
	html.P("""aggregator_type (str): Type of aggregation to perform on the                                data (e.g. mean, max)."""),
	html.P("""dest_lat (str): Column name for destination latitude, if drawing                         lines on map chart."""),
	html.P("""dest_long (str): Column name for destination longitude, if drawing                         lines on map chart."""),
	html.P("""colorscale (str): Colorscale for the choropleth, one of several                           as defined in plotly."""),
	html.P("""projection_type (str): Projection type, one of several as                                defined by plotly."""),
	html.P("""user_id (str): Session/user id."""),
	html.P("""dataset_choice_maps (str): Name of dataset."""),
	html.P(""""""),
	html.H3("""Returns:"""),
	html.P("""dict: The figure to draw."""),
], style={"marginLeft": "20px", "backgroundColor": "#CCE"}),
...
layouts["../EDA_miner/apps/exploration/DashboardMaker"] = html.Div([
html.H2("""DashboardMaker.py"""), 
html.Br(), html.Div([
	html.P(""""""),
], style={"marginLeft": "20px", "backgroundColor": "#CCE"}),
...
html.Br(), html.H3("""Input classes should subclass `GenericInput`. If you add new classes \ """, style={"backgroundColor": "#AAA", "display": "inline"}), 
html.Div([
	html.P("""======== Custom classes ========"""),
	html.P(""""""),
	html.P("""All custom classes should subclass these ones."""),
	html.P("""This is done for checks down the line that"""),
	html.P("""determine properties of nodes of the Graph"""),
	html.P("""which in turn is useful for selecting dataset"""),
	html.P("""and being able to create custom features or"""),
	html.P("""handle outputs"""),
], style={"marginLeft": "20px", "backgroundColor": "#CCE"}),
...
html.Div([
	...
	html.P(""""""),
	html.H3("""Args:"""),
	html.P("""func_name (function): User-defined function."""),
	html.P("""cols (list(str)): Columns used by the transformer."""),
	html.P("""dataset_choice (str): Choice of dataset."""),
	html.P("""user_id: User/session id."""),
], style={"marginLeft": "20px", "backgroundColor": "#CCE"}),

html.Br(), html.H3("""predict(self, X): """, style={"backgroundColor": "#AAA", "display": "inline"}), 
html.Div([
	html.P("""======== Prebuilt classes ========"""),
	html.P(""""""),
	html.P("""For EVERY model that is expected to have parametrization"""),
	html.P("""you are expected to give its class a `modifiable_params`"""),
	html.P("""dict with keys being the function argument and values the"""),
	html.P("""allowed set of values (make it limited, i.e. few choices)"""),
	html.P("""Also, the first is assumed to be the default value which"""),
	html.P("""will be passed to the model upon the creation of pipelines."""),
	html.P("""And of course it must have `fit` and transform methods."""),
], style={"marginLeft": "20px", "backgroundColor": "#CCE"}),

html.Br(), html.H3("""you are expected to give its a `modifiable_params` """, style={"backgroundColor": "#AAA", "display": "inline"}), 
html.Div([
	html.P("""======== Transformers ========"""),
], style={"marginLeft": "20px", "backgroundColor": "#CCE"}),
...
layouts["../EDA_miner/apps/data/Schemata"] = html.Div([
html.Br(), html.H3("""update_schema(n_clicks, table_colnames, row_types, row_subtypes, """, style={"backgroundColor": "#AAA", "display": "inline"}), 
html.Div([
	html.P("""Update the dataset schema. This function takes the html elements from the table head (containing column names) and its first two rows (containing dropdowns with the data types/subtypes), parses     them and stores them in redis."""),
	html.P(""""""),
	html.H3("""Args:"""),
	html.P("""n_clicks (int): Number of button clicks."""),
	html.P("""table_colnames (dict): The head (`html.Thead`) of the table,                                as a Dash dict."""),
	html.P("""row_types (dict): The first table row (`html.Tr`) containing                           the Dash dropdown dict with the data types."""),
	html.P("""row_subtypes (dict): The first table row (`html.Tr`) containing                              the Dash dropdown dict with the data subtypes."""),
	html.P("""dataset_choice (str): Name of dataset."""),
	html.P("""user_id (str): Session/user id."""),
	html.P(""""""),
	html.H3("""Returns:"""),
	html.P("""list(str, bool): A message and a boolean for a browser alert."""),
], style={"marginLeft": "20px", "backgroundColor": "#CCE"}),
...
layouts["../EDA_miner/apps/data/data_utils/schema_heuristics"] = html.Div([
html.Br(), html.H3("""can_into_date(col): """, style={"backgroundColor": "#AAA", "display": "inline"}), 
html.Div([
	html.P("""# Can handle with various separators # e.g.: "-" or "/" or " "     # (time MUST be separated with ":")"""),
	html.P("""YYYY"""),
	html.P("""YYYY-MM"""),
	html.P("""MM-YYYY"""),
	html.P("""YYYY-MM-DD"""),
	html.P("""MM-DD-YYYY"""),
	html.P("""DD-MM-YYYY"""),
	html.P("""DD-MM-YYYY-HRS:MIN"""),
	html.P("""June 1995"""),
	html.P("""03 June 1995"""),
	html.P("""03 Jun 1995"""),
	html.P("""03 June 1995 15:32"""),
	html.P("""15:32 16 Jun 2015"""),
	html.P("""15:32 16th Jun 2015"""),
	html.P("""15:32 Jun 16th 2015"""),
	html.P(""""""),
	html.P("""# Partially handles"""),
	html.P("""15:32  # assumed: Today"""),
	html.P(""""""),
	html.P("""# Cannot handle"""),
	html.P("""YYYY-DD-MM"""),
	html.P(""""""),
	html.P("""# Incorrectly handles"""),
	html.P("""int"""),
	html.P("""float"""),
], style={"marginLeft": "20px", "backgroundColor": "#CCE"}),

html.Br(), html.H3("""can_into_categorical(col, threshold=None): """, style={"backgroundColor": "#AAA", "display": "inline"}), 
html.Div([
	html.P("""Convert to categorical IF the unique values are fewer than some threshold."""),
], style={"marginLeft": "20px", "backgroundColor": "#CCE"}),

html.Br(), html.H3("""can_into_int(col): """, style={"backgroundColor": "#AAA", "display": "inline"}), 
html.Div([
	html.P("""Attempt to convert to int."""),
], style={"marginLeft": "20px", "backgroundColor": "#CCE"}),

html.Br(), html.H3("""column_name_match(col_name, list_of_words, match_threshold=55): """, style={"backgroundColor": "#AAA", "display": "inline"}), 
html.Div([
	html.P("""Helper for matching column names to a list of words."""),
], style={"marginLeft": "20px", "backgroundColor": "#CCE"}),

html.Br(), html.H3("""infer_types(df, is_sample=False): """, style={"backgroundColor": "#AAA", "display": "inline"}), 
html.Div([
	html.P("""Guess data types."""),
	html.P("""float > int > datetime > categorical > string"""),
	html.P(""""""),
	html.P("""1. "Unsafe" assumption. Try to infer datatypes by using directly        "tests" / "transformations"."""),
	html.P("""2. "Lenient" assumption. Pass once over column headers and try to guess the column. Apply the "test" / "transformation" to see if        it works. Overwrite if necessary."""),
	html.P("""3. Try to guess subtypes."""),
	html.P("""4. Anything the user explicitly corrects."""),
	html.P(""""""),
	html.H3("""Args:"""),
	html.P("""df (`pd.DataFrame`): Dataframe on which to run data type inference."""),
	html.P("""is_sample (`bool`): If True then df will be treated as being a sample."""),
	html.P(""""""),
	html.H3("""Returns:"""),
	html.P("""list(dict): Types and subtypes."""),
	html.P(""""""),
	html.H3("""Todo:"""),
	html.P("""When saving these make sure that the 1st and 2nd are marked as         inferred while the 3rd is marked as "ground truth"."""),
], style={"marginLeft": "20px", "backgroundColor": "#CCE"}),
...
html.Br(), html.H3("""ganalytics_connect(client_email, private_key, *, user_id=None): """, style={"backgroundColor": "#AAA", "display": "inline"}), 
html.Div([
	html.P("""Connect to a Google Analytics account."""),
], style={"marginLeft": "20px", "backgroundColor": "#CCE"}),
...
layouts["../EDA_miner/apps/data/data_utils/ganalytics_metrics"] = html.Div([
])
